      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="login/loginOut" onClick="if(!confirm('生气了吗？就因为没有权限?，试着亲我一下，用鼠标点屏幕10下，会有惊喜哦'))return false;">甩头就走</a></li>
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="container animated fadeInDown">
            <center><h1 class="error-number">500</h1></center>
            <h1 class="text-center mb25">Forbiden access ...</h1>
            <p class="text-center s24">You don't have permission to do it</p>
              <p class="text-center s24">我长得辣么美居然不是管理员，谁是管理员，粗来，我保证不打你</p>
            ...
            <div class="text-center mt25">
                <div class="btn-group">
                    ...
                    <a href="mailto:raphael-95@outlook.com?subject=反馈信息" class="btn btn-default btn-lg"><i class="en-mail"></i> 有事找我</a>
                </div>
            </div>
        </div>
        <!-- Javascripts -->
