...
<section class="container-fluid">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="login/loginOut" onClick="if(!confirm('生气了嘛? 换个姿势再试试嘛，不要走吗，求求你啦！'))return false;">甩头就走</a></li>
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
    	...
    	<center><h1 class="lean" style="height:60px;">10101001</h1>
    	<p style="font-fanily:微软雅黑; font-size:20px;">我被主人加密了呢    (￢_￢)</p>
    	<form action="article/deciphering" method="post">
    		<table style="height:120px;">
    			<tr>
    				<td><input type="password" name="ssl" class="form-control" placeholder="请输入主人加密时的秘钥"  style="width:250px;"/></td>
    				<td><input type="submit" class="btn btn-login btn-danger btn-float" value="解" style="font-size:20px; width:80px; height:40px;">
    				<input type="hidden" name="bId" value="${bId }"></td>
    			</tr>
    			<tr><b style="color:red;">${errorPass }</b></tr>
    		</table>
		</form>
	   </center>
