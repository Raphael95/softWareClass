 ...
 <header>
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
        <h1 class="page-header"> 咱们共有<span class="badge">${stuCount }</span>人，四不四很强大！</h1>
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                <th><span class="glyphicon glyphicon-th-large"></span> <span class="visible-lg">学号</span></th>
                <th><span class="glyphicon glyphicon-user"></span> <span class="visible-lg">姓名</span></th>
                <th><span class="glyphicon glyphicon-bookmark"></span> <span class="visible-lg">职务</span></th>
                <th><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">Blog数量</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">手机号码</span></th>
            ...
            <c:forEach items="${students }" var="student">
              <tr>
                ...
                <td>${student.sname }</td>
                <td>${student.job }</td>
                <td>${student.blogs }&nbsp;&nbsp;&nbsp;篇</td>
                <td>${student.tel }</td>
                <td><a href="soft/updateJob/${student.sId }" >修改</a> <a rel="1" name="delete" href="soft/delete/${student.sId }">删除</a> </td>
              </tr>
            </c:forEach>
            </tbody>
          </table>
