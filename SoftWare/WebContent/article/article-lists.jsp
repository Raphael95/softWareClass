      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="login/loginOut" onClick="if(!confirm('真要回家吃饭嘛，哼(⊙_⊙)?'))return false;">回家吃饭</a></li>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-user "></span> <span class="visible-lg">来自</span></th>
              </tr>
            </thead>
            <tbody>
          ...
          <nav>
            ...
            <ul class="pagination pagenav">
            	<c:if test="${blogs.pageNumber > 1}">
            		<li><a href="article/${blogs.pageNumber - 1 }" aria-label="Previous"> <span aria-hidden="true">&laquo;</span> </a> </li>
            	</c:if>
            	<li class="active"><a href="article/${blogs.pageNumber }">第${blogs.pageNumber }页</a></li>
              	<c:if test="${blogs.pageNumber < blogs.totalPage}">
            		 <li><a href="article/${blogs.pageNumber + 1 }" aria-label="Next"> <span aria-hidden="true">&raquo;</span> </a> </li>
            	</c:if>
