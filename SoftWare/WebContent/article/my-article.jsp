  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="article/myBlog">我的Blog</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="article/addArticle">增加文章</a></li>
        </ol>
        <h1 class="page-header">大家的事儿<span class="badge">${blogSize }</span></h1>
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th class="hidden-sm"><span class="glyphicon glyphicon-tag"></span> <span class="visible-lg">描述</span></th>
                <th><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">阅读量</span></th>
                <th><span class="glyphicon glyphicon-time"></span> <span class="visible-lg">日期</span></th>
                <th><span class="glyphicon glyphicon-pencil"></span> <span class="visible-lg">操作</span></th>
              </tr>
            </thead>
            <tbody>
            <c:forEach items="${blogs.getList() }" var="blog">
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="${blog.bId }" /></td>
                <td class="article-title"><a href="article/blog/${blog.bId }">${blog.btitle }</a></td>
                <td>${blog.btype }</td>
                <td class="hidden-sm">${blog.bdes }</td>
                <td>${blog.readCounts }</td>
                <td>${blog.btime }</td>
                <td><a href="article/editArticle/${blog.bId }">修改</a> <a rel="6" href="article/delete/${blog.bId }">删除</a></td>
              </tr>
            </c:forEach>
            </tbody>
          </table>
        ...
        <footer class="message_footer">
          <nav>
            ...
            <ul class="pagination pagenav">
             <c:if test="${blogs.pageNumber > 1}">
            		<li><a href="article/myBlog/${blogs.pageNumber - 1 }" aria-label="Previous"> <span aria-hidden="true">&laquo;</span> </a> </li>
            	</c:if>
            	<li class="active"><a href="article/myBlog/${blogs.pageNumber}">第${blogs.pageNumber }页</a></li>
              	<c:if test="${blogs.pageNumber < blogs.totalPage}">
            		 <li><a href="article/myBlog/${blogs.pageNumber + 1 }" aria-label="Next"> <span aria-hidden="true">&raquo;</span> </a> </li>
            	</c:if>
            </ul>
          </nav>
        </footer>
