  ...
  <div class="row">
   <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="notice/edit" method="post" class="add-article-form">
          <div class="col-md-9">
            <h1 class="page-header">赶紧改，发了消息都能错!</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">标题</label>
              <input type="text" id="article-title" name="notice.ntitle" class="form-control" placeholder="在此处输入标题" required autofocus autocomplete="off" value="${notice.ntitle }">
            </div>
            <div class="form-group">
              <label for="article-content" class="sr-only">内容</label>
              <textarea id="article-content" name="notice.ncontent" class="form-control">${notice.ncontent }</textarea> 
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>类型</span></h2>
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入关键字" name="notice.ntype" autocomplete="off" value="${notice.ntype }" disabled="disabled">
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>更改</span></h2>
              <div class="add-article-box-content">
              	<p><label>状态：</label><span class="article-status-display">未发布</span></p>
                <p><label>发布于：</label><span class="article-time-display"><input style="border: none;" type="datetime" name="notice.ntime" value="<%=time %>" /><input type="hidden" name="notice.snumber" value="${student.snumber }"/><input type="hidden" name="notice.nId" value="${notice.nId }"/></span></p>
              </div>
