      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="login/loginOut" onClick="if(!confirm('回家干吗，留在这陪我(⊙_⊙)?'))return false;">麻麻喊我回家</a></li>
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="row">
          ...
          <div class="col-md-9">
            <h1 class="page-header">赶紧看过来</h1>
             <div class="add-article-box">
              <h2 class="add-article-box-title"><span>公告标题</span></h2>
              <div class="add-article-box-content">
              	<center style="font-size:20px; color:red;">${notice.ntitle }</center>
              </div>
            </div>
            
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>公告正文</span></h2>
              <div class="add-article-box-content">
               <center style="font-size:30px;">${notice.ncontent }</center>
              </div>
            </div>
            
             <div class="add-article-box">
              
              <div class="add-article-box-content"> <span class="prompt-text">看完了还不走?你是想留下来陪我嘛(～￣▽￣)～,麻麻喊你回家吃饭</span> </div>
              <div class="add-article-box-footer">
                <center><a href="javascript: history.go(-1)" class="btn btn-primary" type="submit" name="submit">返回</a></center>
              </div>
            </div>
      </div>
