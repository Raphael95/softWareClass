          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon "></span> <span class="visible-lg">发布人(班委)</span></th>
              </tr>
            </thead>
            <tbody>
        ...
        <footer class="message_footer">
          <nav>
            ...
            <c:if test="${notices.pageNumber > 1}">
            	<li><a href="notice/${notices.pageNumber - 1 }" aria-label="Previous"> <span aria-hidden="true">&laquo;</span> </a> </li>
            </c:if>
            	<li class="active"><a href="notice/${notices.pageNumber }">第${notices.pageNumber }页</a></li>
            <c:if test="${notices.pageNumber < notices.totalPage}">
            	<li><a href="notice/${notices.pageNumber + 1 }" aria-label="Next"> <span aria-hidden="true">&raquo;</span> </a> </li>
            </c:if>
            </ul>
          </nav>
        </footer>
